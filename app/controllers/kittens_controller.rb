class KittensController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @kitten.save
        format.html { redirect_to kitten_url(@kitten), notice: "Meow! Kitten was successfully created." }
  ...
  def update
    respond_to do |format|
      if @kitten.update(kitten_params)
        format.html { redirect_to kitten_url(@kitten), notice: "Meow! Kitten was successfully updated." }
